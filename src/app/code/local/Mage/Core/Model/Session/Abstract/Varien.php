...
class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
{
    ...
    /**
     * Destructor to write the session back after the request. This is
     * necessary to write the session back to the target because a other
     * request possiby started a new session and session-ID has changed.
     * 
     * @return void
     */
    ...
    public function start($sessionName=null)
    {
        ...
        if (session_status() == PHP_SESSION_ACTIVE && !$this->getSkipEmptySessionCheck()) {
            return $this;
        }
    ...
    public function init($namespace, $sessionName=null)
    {
        ...
        if (session_status() == PHP_SESSION_NONE) {
            // ATTENTION: This is necessary because a new request 
            // could have started a new session with a different ID
            $this->setSessionId($_COOKIE[$sessionName]);
